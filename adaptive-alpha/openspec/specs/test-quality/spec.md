...
## Purpose
Maintain complete Python statement coverage through reproducible offline tests of research, execution and service boundaries, with a shared local/CI quality gate and reviewable reports.
